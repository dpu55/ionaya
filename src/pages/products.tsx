...
const products = [
  {
    ...
    description:
      "Mengandung mikroalga Tetraselmis chuii dan fiber prebiotik presisi. Kombinasi manfaat antioksidan tinggi dan mikrobioma baik untuk solusi kesehatan yang menyeluruh.",
  },
  {
    id: 2,
    name: "Magna",
...
const ProductsPage: React.FC = () => {
  return (
    <>
      <Head>
        <title>Katalog Produk | Ionaya</title>
        <meta name="description" content="Lihat berbagai produk berkualitas dari IONAYA, termasuk Vitera dan Magna." />
      </Head>
